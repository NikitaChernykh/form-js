...
const USA_ZIPCODE_PATTERN = /^[0-9]{5}-[0-9]{4}$/;
...
export class Validator {
  ...
  validateField(field, value) {
    ...
    if ('validationType' in evaluatedValidation && value && evaluatedValidation.validationType === 'zipcode' && !USA_ZIPCODE_PATTERN.test(value)) {
      errors = [
        ...errors,
        'Field must be a valid USA zip code (e.g. 12345 or 12345-6789)'
      ];
    }
